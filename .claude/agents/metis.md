...
#### 2. AI 슬롭 패턴 탐지 (AI Slop Detection)

> "AI가 만들어내는 전형적인 과잉 패턴"
...
**범위 확대 (Scope Creep)**
- ⚠️ 요청하지 않은 기능 추가
- ⚠️ "향후 확장성을 위해" 불필요한 구조
- ⚠️ 원래 요청 대비 2x+ 범위 증가

**과다 검증**
- ⚠️ 모든 가능한 에러 케이스 처리 (불필요한 것 포함)
- ⚠️ 과도한 로깅/디버깅 코드
- ⚠️ 방어적 코딩 과잉
...
## 의도 분류
**유형**: [Refactoring/Build from Scratch/Mid-sized/Architecture/Research]
**신뢰도**: High/Medium/Low
